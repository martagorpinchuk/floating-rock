...
export class BlueSphereMaterial extends ShaderMaterial {
    ...
    constructor ( ) {
        ...
        this.uniforms = {
            ...
            uTime: { value: 0.0 },
            uColorRed: { value: new Color( 0x0a30ad ) },
            uColorDarkRed: { value: new Color( 0x0a1363 ) },
            uDirection: { value: new Vector3( - 0.1, - 0.10, - 0.2 ) },
            uLightColor: { value: new Color( 0xcfdfe8 ) },
